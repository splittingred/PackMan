...
$basePath = $modx->getOption('temppack.core_path',null,$modx->getOption('core_path').'components/templatepackager/');
require_once $basePath.'model/templatepackager/templatepackager.class.php';
$modx->tp = new TemplatePackager($modx);

$modx->lexicon->load('templatepackager:default');
