...
$_lang['packman.create_new...'] = 'Create New...';
$_lang['packman.directory'] = 'Directory';
$_lang['packman.export'] = 'Export Transport Package';
$_lang['packman.intro_msg'] = 'To create a Transport Package, simply choose a Category name for your package. Then specify any Templates, Snippets, Chunks and/or Subpackages you want in the Package. You can then optionally specify a readme and/or license file to include with the Package. Finally, specify the version number and release of this Transport Package.';
...
$_lang['packman.package_name_desc'] = 'The name of the Package that will be created. A Category will be created with this name, and all packaged Elements will be assigned to it.';$_lang['packman.chunk'] = 'Chunk';
...
$_lang['packman.profile_name'] = 'Profile Name';
